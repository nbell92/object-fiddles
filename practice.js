...
for (var property in alsoMe) {
  if (alsoMe.hasOwnProperty(property)) {
      console.log(property + " --> " + alsoMe[property]);
    }
  }
...
that each value is truthy. If it's not truthy, remove it from the object. */
  ...
  for (var property in user1){
    if (user1[property] || user1[property] === true){
        continue;
       }
      else {
...
//Once you get your truthy Object, Change the remaining values in the object to be specific to you (name: 'your name', username: 'your username'), rather than my information.
  ...
  //Code Here
  user1.name = 'Nichole Bell';
  user1.pwHash = 'PaSword0';
  user1.username = 'nbell92';
console.log(user1);
//NEXT PROBLEM
